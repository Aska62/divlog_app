    ...
    <>
      ...
      <form action="#" className="w-11/12 max-w-xl h-fit mx-auto my-12">
        ...
        <div className="w-full h-14 my-3 flex justify-between items-start">
          ...
          <div className="w-8/12">
            <input
              ...
              name="logNo"
              placeholder="Log no."
              className="w-full h-8 bg-lightBlue px-2 rounded-s text-black"
            />
        ...
        <div className="w-full h-14 my-3 flex justify-between items-start">
          ...
          <div className="w-8/12">
            <select name="purpose" id="purpose" className="bg-lightBlue w-full h-8 px-2 rounded-sm text-black">
        ...
        <div className="w-full h-14 my-3 flex justify-between items-start">
          ...
          <div className="w-8/12">
            <select name="purpose" id="country_region" className="bg-lightBlue w-full h-8 px-2 rounded-sm text-black">
        ...
        <div className="w-full h-fit my-3 flex flex-col items-start">
          ...
          <div className="w-full">
            <textarea
              ...
              id="note"
              placeholder="Dive Center"
              className="w-full h-60 bg-lightBlue px-2 rounded-s text-black"
            />
            <p className="text-eyeCatchDark text-end">{}</p>
          </div>
        </div>
